...
export function AddRecurringExpenseModal({ isOpen, onClose, onSave, people, categories }: AddRecurringExpenseModalProps) {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    if (!formData.name || !formData.category || !formData.subcategory || !formData.description || !formData.paidBy) {
      return;
    }
