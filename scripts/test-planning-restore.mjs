...
const db=new pg.Client({host:'127.0.0.1',port:55432,user:'famfi_preview_app',database:'postgres'});
...
try{
  ...
  const payload=await captureHouseholdBackup((sql,values)=>db.query(sql,values),owner,'famfi-expenses/v6','famfi_preview');
