...
import { ArrowLeftRight, CalendarClock, History, LogOut, Menu, Plus, ReceiptText, Settings2, UserRound } from 'lucide-react';
...
export function BottomNavigation({ view, attention, ready, busy, onNavigate, onAdd, onMasters, onProfile, onLogout }: {
  ...
  return <nav className="bottom-navigation" aria-label="メインメニュー">
    ...
    <Sheet open={open} onOpenChange={setOpen}>
      <SheetTrigger asChild><button type="button" aria-current={view === 'history' ? 'page' : undefined}><Menu aria-hidden="true" /><span>メニュー</span></button></SheetTrigger>
