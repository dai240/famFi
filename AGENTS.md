...
- No owner Auth account is provisioned yet. Do not describe the app as ready for real usage until actual email login, own-data CRUD, and initial backup/restore are verified. Local Auth fixtures are not evidence of email delivery.
